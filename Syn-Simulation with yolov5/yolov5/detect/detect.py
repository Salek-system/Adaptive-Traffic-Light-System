...
class DetectEmergency :
    def __init__(self , weights= None , conf= None , img_size = None , source = None):
            ...
            for i, det in enumerate(pred):  # per image
                ...
                if len(det):
                    ...
                    for c in det[:, 5].unique():
                        ...
                        #print (" # detections per class {}".format((det[:, 5] == c).sum()))
                        #print (" # add to string {}".format(names[int(c)]))
                        if n == 1   and (names[int(c)] == 'emergency'):
                            self.set_detected()
                            #print ("True")
